    ...
    >
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-pink-500 to-purple-300 bg-clip-text text-transparent leading-right">
            Hi, I'm Sakshi Nirmal
          </h1>

          <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
          A tech enthusiast who believes in innovation, efficiency, and
              continuous growth. With expertise in React, Node.js, and MongoDB,
              I craft scalable web solutions that deliver seamless user
