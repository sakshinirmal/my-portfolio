  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Next.js", icon: faReact, level: 90, color: "#000000" },
        ...
        { name: "Axios", icon: faCode, level: 85, color: "#5A29E4" },
        { name: "jQuery", icon: faJs, level: 80, color: "#0769AD" },
        { name: "Framer Motion", icon: faCode, level: 85, color: "#0055FF" },
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "JWT Auth", icon: faLock, level: 85, color: "#000000" },
        ...
        { name: "Firebase", icon: faCloud, level: 85, color: "#FFCA28" },
        { name: "WebSockets", icon: faNetworkWired, level: 80, color: "#4CAF50" },
        { name: "Pinecone", icon: faDatabase, level: 75, color: "#4A90E2" },
        { name: "FaceNet", icon: faBrain, level: 75, color: "#FF6B6B" },
      ]
    },
    {
      title: "DevOps & Tools",
      ...
      skills: [
        ...
        { name: "Kubernetes", icon: faCode, level: 80, color: "#326CE5" },
        { name: "AWS", icon: faAws, level: 85, color: "#FF9900" },
        { name: "Git", icon: faGit, level: 90, color: "#F05032" },
        { name: "CI/CD", icon: faCodeBranch, level: 80, color: "#4CAF50" },
        { name: "Jest", icon: faCode, level: 85, color: "#C21325" },
        { name: "Cypress", icon: faCode, level: 80, color: "#17202C" },
        { name: "DSA", icon: faCode, level: 85, color: "#FF6B6B" },
        { name: "Agile", icon: faRocket, level: 90, color: "#4CAF50" },
